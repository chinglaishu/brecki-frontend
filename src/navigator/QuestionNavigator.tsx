...
export const QuestionStack: FC<PageProps> = ({navigation}) => {
  ...
  const getContent = (contextObj: ContextObj) => {
    ...
    const {language} = user;
    return (
      <Stack.Navigator initialRouteName={SCREEN.QUESTION} screenOptions={{animationEnabled: true, header: (props) => null }}
        ...
        <Stack.Screen name={SCREEN.QUESTION_END} component={QuestionEnd} initialParams={{changeStatusModal}}/>
      </Stack.Navigator>
    );
  };
